...
free(void *ap)
{
 ...
 591:	a1 8c 07 00 00       	mov    0x78c,%eax
{
 ...
 5d1:	5b                   	pop    %ebx
  freep = p;
 5d2:	89 15 8c 07 00 00    	mov    %edx,0x78c
}
 5d8:	5e                   	pop    %esi
 5d9:	5f                   	pop    %edi
 5da:	5d                   	pop    %ebp
 ...
 609:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 60c:	89 15 8c 07 00 00    	mov    %edx,0x78c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 3d 8c 07 00 00    	mov    0x78c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66f:	73 4f                	jae    6c0 <malloc+0xa0>
    ...
    if(p == freep)
 671:	8b 3d 8c 07 00 00    	mov    0x78c,%edi
 ...
 69a:	e8 f1 fe ff ff       	call   590 <free>
  return freep;
 69f:	8b 15 8c 07 00 00    	mov    0x78c,%edx
 ...
 6cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6cf:	89 15 8c 07 00 00    	mov    %edx,0x78c
}
 ...
 6df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 8c 07 00 00 90 	movl   $0x790,0x78c
 6e7:	07 00 00 
    base.s.size = 0;
 6ea:	bf 90 07 00 00       	mov    $0x790,%edi
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 90 07 00 00 90 	movl   $0x790,0x790
 6f6:	07 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 6f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6fb:	c7 05 94 07 00 00 00 	movl   $0x0,0x794
 702:	00 00 00 
    if(p->s.size >= nunits){
