  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  f4:	74 42                	je     138 <wc+0x98>
      if(buf[i] == '\n')
  f6:	0f be 87 20 09 00 00 	movsbl 0x920(%edi),%eax
        l++;
...
free(void *ap)
{
 ...
 6e1:	a1 20 0b 00 00       	mov    0xb20,%eax
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	89 15 20 0b 00 00    	mov    %edx,0xb20
}
 728:	5e                   	pop    %esi
 729:	5f                   	pop    %edi
 72a:	5d                   	pop    %ebp
 ...
 759:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 75c:	89 15 20 0b 00 00    	mov    %edx,0xb20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d 20 0b 00 00    	mov    0xb20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 4f                	jae    810 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	8b 3d 20 0b 00 00    	mov    0xb20,%edi
 ...
 7ea:	e8 f1 fe ff ff       	call   6e0 <free>
  return freep;
 7ef:	8b 15 20 0b 00 00    	mov    0xb20,%edx
 ...
 81c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 81f:	89 15 20 0b 00 00    	mov    %edx,0xb20
}
 ...
 82f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 20 0b 00 00 24 	movl   $0xb24,0xb20
 837:	0b 00 00 
    base.s.size = 0;
 83a:	bf 24 0b 00 00       	mov    $0xb24,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 24 0b 00 00 24 	movl   $0xb24,0xb24
 846:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 84b:	c7 05 28 0b 00 00 00 	movl   $0x0,0xb28
 852:	00 00 00 
    if(p->s.size >= nunits){
