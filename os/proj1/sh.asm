...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      40:	80 3d 42 14 00 00 20 	cmpb   $0x20,0x1442
...
fork1(void)
{
  ...
  memset(buf, 0, nbuf);
      ...
      79:	6a 64                	push   $0x64
      7b:	6a 00                	push   $0x0
      7d:	68 40 14 00 00       	push   $0x1440
      82:	e8 09 0c 00 00       	call   c90 <memset>
  gets(buf, nbuf);
      87:	58                   	pop    %eax
      88:	5a                   	pop    %edx
      89:	6a 64                	push   $0x64
      8b:	68 40 14 00 00       	push   $0x1440
      90:	e8 5b 0c 00 00       	call   cf0 <gets>
  if(buf[0] == 0) // EOF
      95:	0f b6 05 40 14 00 00 	movzbl 0x1440,%eax
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      a7:	80 3d 41 14 00 00 64 	cmpb   $0x64,0x1441
     ...
     100:	51                   	push   %ecx
     101:	68 43 14 00 00       	push   $0x1443
     106:	68 61 13 00 00       	push   $0x1361
     10b:	6a 02                	push   $0x2
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 55 13 00 00       	push   $0x1355
     17e:	6a 02                	push   $0x2
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 70 13 00 00 	jmp    *0x1370(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1e9:	68 c7 12 00 00       	push   $0x12c7
     1ee:	6a 02                	push   $0x2
     1f0:	e8 9b 0d 00 00       	call   f90 <printf>
    break;
    ...
    panic("runcmd");
     ...
     2ad:	68 c0 12 00 00       	push   $0x12c0
     2b2:	e8 b9 fe ff ff       	call   170 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2b7:	51                   	push   %ecx
     2b8:	ff 73 08             	push   0x8(%ebx)
     2bb:	68 d7 12 00 00       	push   $0x12d7
     2c0:	6a 02                	push   $0x2
     2c2:	e8 c9 0c 00 00       	call   f90 <printf>
      exit();
     2c7:	e8 57 0b 00 00       	call   e23 <exit>
      panic("pipe");
     2cc:	83 ec 0c             	sub    $0xc,%esp
     2cf:	68 e7 12 00 00       	push   $0x12e7
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 1c 14 00 00       	push   $0x141c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 1c 14 00 00       	push   $0x141c
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 14 14 00 00       	push   $0x1414
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 1c 14 00 00       	push   $0x141c
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 1c 14 00 00       	push   $0x141c
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 09 13 00 00       	push   $0x1309
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     6c2:	e8 f9 0a 00 00       	call   11c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     721:	e8 9a 0a 00 00       	call   11c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     77e:	68 ec 12 00 00       	push   $0x12ec
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 0c 13 00 00       	push   $0x130c
     7a4:	57                   	push   %edi
     7a5:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     7bb:	6a 54                	push   $0x54
     7bd:	e8 fe 09 00 00       	call   11c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 23 13 00 00       	push   $0x1323
     80b:	57                   	push   %edi
     80c:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 15 13 00 00       	push   $0x1315
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 0e 13 00 00       	push   $0x130e
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 28 13 00 00       	push   $0x1328
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     90d:	e8 ae 08 00 00       	call   11c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000940 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     972:	e8 49 08 00 00       	call   11c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 2a 13 00 00       	push   $0x132a
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 26 13 00 00       	push   $0x1326
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     9ed:	e8 ce 07 00 00       	call   11c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 0c 13 00 00       	push   $0x130c
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 48 13 00 00       	push   $0x1348
  cmd = parseline(ps, es);
     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 d6 12 00 00       	push   $0x12d6
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     bae:	52                   	push   %edx
     baf:	50                   	push   %eax
     bb0:	68 4a 13 00 00       	push   $0x134a
     bb5:	6a 02                	push   $0x2
     bb7:	e8 d4 03 00 00       	call   f90 <printf>
    panic("syntax");
     bbc:	c7 04 24 0e 13 00 00 	movl   $0x130e,(%esp)
     ...
     eec:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f19:	0f b6 92 00 14 00 00 	movzbl 0x1400(%edx),%edx
  ...
  write(fd, &c, 1);
     ...
     f5e:	56                   	push   %esi
     f5f:	57                   	push   %edi
     f60:	e8 de fe ff ff       	call   e43 <write>
  while(--i >= 0)
     ...
     f99:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
     ...
     fd5:	57                   	push   %edi
     fd6:	56                   	push   %esi
     fd7:	e8 67 fe ff ff       	call   e43 <write>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1009:	ff 24 85 a8 13 00 00 	jmp    *0x13a8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    102e:	e8 10 fe ff ff       	call   e43 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    103f:	57                   	push   %edi
    1040:	56                   	push   %esi
    1041:	e8 fd fd ff ff       	call   e43 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    10ab:	57                   	push   %edi
    10ac:	56                   	push   %esi
    10ad:	e8 91 fd ff ff       	call   e43 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    10ef:	e8 4f fd ff ff       	call   e43 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    1117:	90                   	nop
          s = "(null)";
    1118:	ba a0 13 00 00       	mov    $0x13a0,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1131:	a1 a4 14 00 00       	mov    0x14a4,%eax
{
  ...
  freep = p;
    ...
    1171:	5b                   	pop    %ebx
  freep = p;
    1172:	89 15 a4 14 00 00    	mov    %edx,0x14a4
}
    1178:	5e                   	pop    %esi
    1179:	5f                   	pop    %edi
    117a:	5d                   	pop    %ebp
  ...
  freep = p;
    11ac:	89 15 a4 14 00 00    	mov    %edx,0x14a4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11cc:	8b 3d a4 14 00 00    	mov    0x14a4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1211:	8b 3d a4 14 00 00    	mov    0x14a4,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1223:	e8 83 fc ff ff       	call   eab <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    123f:	8b 15 a4 14 00 00    	mov    0x14a4,%edx
    ...
    126c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    126f:	89 15 a4 14 00 00    	mov    %edx,0x14a4
}
    ...
    127f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1280:	c7 05 a4 14 00 00 a8 	movl   $0x14a8,0x14a4
    1287:	14 00 00 
    base.s.size = 0;
    128a:	bf a8 14 00 00       	mov    $0x14a8,%edi
    base.s.ptr = freep = prevp = &base;
    128f:	c7 05 a8 14 00 00 a8 	movl   $0x14a8,0x14a8
    1296:	14 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1299:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    129b:	c7 05 ac 14 00 00 00 	movl   $0x0,0x14ac
    12a2:	00 00 00 
    if(p->s.size >= nunits){
