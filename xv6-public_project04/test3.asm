  ...
  10:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "[Test 3] Make Copies\n");
  16:	68 c8 07 00 00       	push   $0x7c8
  1b:	6a 01                	push   $0x1
  1d:	e8 7e 04 00 00       	call   4a0 <printf>
  int parent_initial_fp = countfp();
  22:	e8 9c 03 00 00       	call   3c3 <countfp>
  27:	83 c4 10             	add    $0x10,%esp
  2a:	89 c6                	mov    %eax,%esi
  for(int i = 0; i < 10; i++){
  2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    pid = fork();
  30:	e8 e6 02 00 00       	call   31b <fork>
    if(pid == 0){
  35:	85 c0                	test   %eax,%eax
  37:	74 4b                	je     84 <main+0x84>
  for(int i = 0; i < 10; i++){
  39:	83 c3 01             	add    $0x1,%ebx
  3c:	83 fb 0a             	cmp    $0xa,%ebx
  ...
  for(int i = 0; i < 10; i++){
    wait();
  48:	e8 de 02 00 00       	call   32b <wait>
  for(int i = 0; i < 10; i++){
  ...
  52:	e8 6c 03 00 00       	call   3c3 <countfp>
  57:	39 f0                	cmp    %esi,%eax
  59:	74 16                	je     71 <main+0x71>
        printf(1, "[Test 3] fail\n\n");
  5b:	52                   	push   %edx
  5c:	52                   	push   %edx
  5d:	68 f7 07 00 00       	push   $0x7f7
  62:	6a 01                	push   $0x1
  ...
  71:	50                   	push   %eax
  72:	50                   	push   %eax
  73:	68 07 08 00 00       	push   $0x807
  78:	6a 01                	push   $0x1
  7a:	e8 21 04 00 00       	call   4a0 <printf>
  7f:	83 c4 10             	add    $0x10,%esp
  82:	eb e8                	jmp    6c <main+0x6c>
      sleep(100 + 50 * i);
  84:	6b c3 32             	imul   $0x32,%ebx,%eax
  87:	83 ec 0c             	sub    $0xc,%esp
  8a:	83 c0 64             	add    $0x64,%eax
  8d:	50                   	push   %eax
  8e:	e8 20 03 00 00       	call   3b3 <sleep>
      int child_initial_fp = countfp();
  93:	e8 2b 03 00 00       	call   3c3 <countfp>
      initial_data = 1;
  98:	c7 05 30 0b 00 00 01 	movl   $0x1,0xb30
  9f:	00 00 00 
      int child_initial_fp = countfp();
  a2:	89 c7                	mov    %eax,%edi
      int child_modified_fp = countfp();
  a4:	e8 1a 03 00 00       	call   3c3 <countfp>
  a9:	89 c6                	mov    %eax,%esi
      printf(1, "child [%d]'s result: %d\n", i,child_initial_fp - child_modified_fp);
  ab:	89 f8                	mov    %edi,%eax
  ad:	29 f0                	sub    %esi,%eax
  af:	50                   	push   %eax
  b0:	53                   	push   %ebx
  b1:	68 de 07 00 00       	push   $0x7de
  b6:	6a 01                	push   $0x1
  b8:	e8 e3 03 00 00       	call   4a0 <printf>
      if((child_initial_fp - child_modified_fp) == 0)
  bd:	83 c4 20             	add    $0x20,%esp
  c0:	39 f7                	cmp    %esi,%edi
  c2:	75 a8                	jne    6c <main+0x6c>
  c4:	eb 95                	jmp    5b <main+0x5b>
  c6:	66 90                	xchg   %ax,%ax
  c8:	66 90                	xchg   %ax,%ax
  ca:	66 90                	xchg   %ax,%ax
  cc:	66 90                	xchg   %ax,%ax
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 17 08 00 00       	mov    $0x817,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 34 0b 00 00       	mov    0xb34,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 34 0b 00 00    	mov    %edx,0xb34
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 34 0b 00 00    	mov    %edx,0xb34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 34 0b 00 00    	mov    0xb34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 34 0b 00 00    	mov    0xb34,%edi
 ...
 733:	e8 73 fc ff ff       	call   3ab <sbrk>
  if(p == (char*)-1)
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 34 0b 00 00    	mov    0xb34,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 34 0b 00 00    	mov    %edx,0xb34
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 34 0b 00 00 38 	movl   $0xb38,0xb34
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 38 0b 00 00       	mov    $0xb38,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 38 0b 00 00 38 	movl   $0xb38,0xb38
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 3c 0b 00 00 00 	movl   $0x0,0xb3c
 7b2:	00 00 00 
    if(p->s.size >= nunits){
