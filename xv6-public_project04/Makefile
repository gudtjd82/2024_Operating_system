...
ifeq ($(shell uname), Darwin) # it only works when in OSX!ds
...
ifndef CFLAGS
CFLAGS = -fno-pic -static -fno-builtin -fno-strict-aliasing -O2 -Wall -MD -ggdb -m32 -Werror -fno-omit-frame-pointer -Wno-error=stringop-overflow=0
endif
