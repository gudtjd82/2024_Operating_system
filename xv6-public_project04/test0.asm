...
main(int argc, char* argv[])
{
  ...
  19:	6a 01                	push   $0x1
  1b:	e8 70 04 00 00       	call   490 <printf>

  int numfp = countfp();
  20:	e8 8e 03 00 00       	call   3b3 <countfp>
  25:	89 45 dc             	mov    %eax,-0x24(%ebp)
  int numvp = countvp();
  28:	e8 8e 03 00 00       	call   3bb <countvp>
  2d:	89 c6                	mov    %eax,%esi
  int numpp = countpp();
  2f:	e8 8f 03 00 00       	call   3c3 <countpp>
  ...
  sbrk(4096);
  44:	e8 52 03 00 00       	call   39b <sbrk>

  int numfpa = countfp();
  49:	e8 65 03 00 00       	call   3b3 <countfp>
  4e:	89 45 d8             	mov    %eax,-0x28(%ebp)
  int numvpa = countvp();
  51:	e8 65 03 00 00       	call   3bb <countvp>
  56:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  int numppa = countpp();
  59:	e8 65 03 00 00       	call   3c3 <countpp>
  ...
  66:	50                   	push   %eax
  67:	57                   	push   %edi
  68:	68 ca 07 00 00       	push   $0x7ca
  6d:	6a 01                	push   $0x1
  6f:	e8 1c 04 00 00       	call   490 <printf>

  if((numvp == numpp) && (numvpa == numppa) && (numfp - numfpa == 1))
  74:	83 c4 20             	add    $0x20,%esp
  77:	39 de                	cmp    %ebx,%esi
  79:	75 13                	jne    8e <main+0x8e>
  7b:	8b 5d e0             	mov    -0x20(%ebp),%ebx
  7e:	39 5d e4             	cmp    %ebx,-0x1c(%ebp)
  81:	75 0b                	jne    8e <main+0x8e>
  83:	8b 55 dc             	mov    -0x24(%ebp),%edx
  86:	2b 55 d8             	sub    -0x28(%ebp),%edx
  89:	83 fa 01             	cmp    $0x1,%edx
  8c:	74 17                	je     a5 <main+0xa5>
    printf(1, "[Test 0] pass\n\n");
  else
    printf(1, "[Test 0] fail\n\n");
  8e:	83 ec 08             	sub    $0x8,%esp
  91:	68 e6 07 00 00       	push   $0x7e6
  96:	6a 01                	push   $0x1
  98:	e8 f3 03 00 00       	call   490 <printf>
  9d:	83 c4 10             	add    $0x10,%esp

  exit();
  a0:	e8 6e 02 00 00       	call   313 <exit>
    printf(1, "[Test 0] pass\n\n");
  a5:	50                   	push   %eax
  a6:	50                   	push   %eax
  a7:	68 d6 07 00 00       	push   $0x7d6
  ac:	6a 01                	push   $0x1
  ae:	e8 dd 03 00 00       	call   490 <printf>
  b3:	83 c4 10             	add    $0x10,%esp
  b6:	eb e8                	jmp    a0 <main+0xa0>
  b8:	66 90                	xchg   %ax,%ax
  ba:	66 90                	xchg   %ax,%ax
  bc:	66 90                	xchg   %ax,%ax
  be:	66 90                	xchg   %ax,%ax
 ...
 3ec:	89 d1                	mov    %edx,%ecx
{
 ...
 419:	0f b6 92 58 08 00 00 	movzbl 0x858(%edx),%edx
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 00 08 00 00 	jmp    *0x800(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba f6 07 00 00       	mov    $0x7f6,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 0c 0b 00 00 10 	movl   $0xb10,0xb0c
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 10 0b 00 00       	mov    $0xb10,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
