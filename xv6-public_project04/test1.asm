...
main(int argc, char *argv[])
{
  ...
  parent_fp = countfp();
  1e:	e8 50 03 00 00       	call   373 <countfp>
  23:	89 c3                	mov    %eax,%ebx

  pid = fork();
  25:	e8 a1 02 00 00       	call   2cb <fork>
  if(pid == 0){
  2a:	83 c4 10             	add    $0x10,%esp
  2d:	85 c0                	test   %eax,%eax
  2f:	75 23                	jne    54 <main+0x54>
    child_fp = countfp();
  31:	e8 3d 03 00 00       	call   373 <countfp>
  36:	89 c2                	mov    %eax,%edx
    
    if(parent_fp - child_fp == 68)
  38:	89 d8                	mov    %ebx,%eax
  3a:	29 d0                	sub    %edx,%eax
  3c:	83 f8 44             	cmp    $0x44,%eax
  3f:	74 1d                	je     5e <main+0x5e>
      printf(1, "[Test 1] pass\n\n");
    else
      printf(1, "[Test 1] fail\n\n");
  41:	50                   	push   %eax
  42:	50                   	push   %eax
  43:	68 a2 07 00 00       	push   $0x7a2
  48:	6a 01                	push   $0x1
  4a:	e8 01 04 00 00       	call   450 <printf>
  4f:	83 c4 10             	add    $0x10,%esp
    
    exit();
  52:	eb 05                	jmp    59 <main+0x59>
  }
  else{
    wait();
  54:	e8 82 02 00 00       	call   2db <wait>
  }

  exit();
  59:	e8 75 02 00 00       	call   2d3 <exit>
      printf(1, "[Test 1] pass\n\n");
  5e:	52                   	push   %edx
  5f:	52                   	push   %edx
  60:	68 92 07 00 00       	push   $0x792
  65:	6a 01                	push   $0x1
  67:	e8 e4 03 00 00       	call   450 <printf>
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 bc 07 00 00 	jmp    *0x7bc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba b2 07 00 00       	mov    $0x7b2,%edx
        while(*s != 0){
