...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 45 02 00 00       	call   27f <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 30c:	8a 92 bc 06 00 00    	mov    0x6bc(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 3c1:	ff 24 85 64 06 00 00 	jmp    *0x664(,%eax,4)
        state = '%';
 ...
 4bc:	b0 28                	mov    $0x28,%al
          s = "(null)";
 4be:	ba 5d 06 00 00       	mov    $0x65d,%edx
...
free(void *ap)
{
 ...
 4d8:	a1 d0 06 00 00       	mov    0x6d0,%eax
 ...
 505:	89 08                	mov    %ecx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 507:	a3 d0 06 00 00       	mov    %eax,0x6d0
}
 50c:	5b                   	pop    %ebx
 50d:	5e                   	pop    %esi
 50e:	5f                   	pop    %edi
 ...
 51a:	72 d2                	jb     4ee <free+0x22>
{
 ...
 540:	89 08                	mov    %ecx,(%eax)
  freep = p;
 542:	a3 d0 06 00 00       	mov    %eax,0x6d0
}
 547:	5b                   	pop    %ebx
 548:	5e                   	pop    %esi
 549:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 55e:	47                   	inc    %edi
  if((prevp = freep) == 0){
 55f:	8b 15 d0 06 00 00    	mov    0x6d0,%edx
 ...
 595:	73 41                	jae    5d8 <malloc+0x8c>
    ...
    if(p == freep)
 597:	3b 05 d0 06 00 00    	cmp    0x6d0,%eax
 ...
 5ba:	e8 0d ff ff ff       	call   4cc <free>
  return freep;
 5bf:	8b 15 d0 06 00 00    	mov    0x6d0,%edx
 ...
 5e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 5e7:	89 15 d0 06 00 00    	mov    %edx,0x6d0
      return (void*)(p + 1);
 ...
 5ff:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 600:	c7 05 d0 06 00 00 d4 	movl   $0x6d4,0x6d0
 607:	06 00 00 
 60a:	c7 05 d4 06 00 00 d4 	movl   $0x6d4,0x6d4
 611:	06 00 00 
    base.s.size = 0;
 614:	c7 05 d8 06 00 00 00 	movl   $0x0,0x6d8
 61b:	00 00 00 
 61e:	b8 d4 06 00 00       	mov    $0x6d4,%eax
