...
main(void)
{
  ...
  10:	83 ec 0c             	sub    $0xc,%esp
    int cnt, numPG;
    cnt = countfp();
  13:	e8 2b 03 00 00       	call   343 <countfp>
  18:	89 c6                	mov    %eax,%esi
    numPG = countvp();
  1a:	e8 2c 03 00 00       	call   34b <countvp>
  ...
  23:	89 c3                	mov    %eax,%ebx
    printf(1, "The num of total free page in the system: %d\n", cnt);
  25:	68 48 07 00 00       	push   $0x748
  2a:	6a 01                	push   $0x1
  2c:	e8 ef 03 00 00       	call   420 <printf>
    printf(1, "The num of page in the current process: %d\n", numPG);
  31:	83 c4 0c             	add    $0xc,%esp
  34:	53                   	push   %ebx
  35:	68 78 07 00 00       	push   $0x778
  3a:	6a 01                	push   $0x1
  3c:	e8 df 03 00 00       	call   420 <printf>
    exit();
  41:	e8 5d 02 00 00       	call   2a3 <exit>
  46:	66 90                	xchg   %ax,%ax
  48:	66 90                	xchg   %ax,%ax
  4a:	66 90                	xchg   %ax,%ax
  4c:	66 90                	xchg   %ax,%ax
 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 04 08 00 00 	movzbl 0x804(%edx),%edx
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 ac 07 00 00 	jmp    *0x7ac(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba a4 07 00 00       	mov    $0x7a4,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 b4 0a 00 00       	mov    0xab4,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 b4 0a 00 00    	mov    %edx,0xab4
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 b4 0a 00 00    	mov    %edx,0xab4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d b4 0a 00 00    	mov    0xab4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d b4 0a 00 00    	mov    0xab4,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 b4 0a 00 00    	mov    0xab4,%edx
 ...
 6fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 b4 0a 00 00    	mov    %edx,0xab4
}
 ...
 70f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 b4 0a 00 00 b8 	movl   $0xab8,0xab4
 717:	0a 00 00 
    base.s.size = 0;
 71a:	bf b8 0a 00 00       	mov    $0xab8,%edi
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 b8 0a 00 00 b8 	movl   $0xab8,0xab8
 726:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 bc 0a 00 00 00 	movl   $0x0,0xabc
 732:	00 00 00 
    if(p->s.size >= nunits){
