...
main(int argc, char *argv[])
{
  ...
  12:	68 78 07 00 00       	push   $0x778
  17:	6a 01                	push   $0x1
  19:	e8 32 04 00 00       	call   450 <printf>
  int pid;

  pid = fork();
  1e:	e8 a8 02 00 00       	call   2cb <fork>
  if(pid == 0){
  23:	83 c4 10             	add    $0x10,%esp
  26:	85 c0                	test   %eax,%eax
  28:	75 30                	jne    5a <main+0x5a>
    int child_initial_fp = countfp();
  2a:	e8 44 03 00 00       	call   373 <countfp>

    initial_data = 1;
  2f:	c7 05 bc 0a 00 00 01 	movl   $0x1,0xabc
  36:	00 00 00 
    int child_initial_fp = countfp();
  39:	89 c3                	mov    %eax,%ebx
  
    int child_modified_fp = countfp();
  3b:	e8 33 03 00 00       	call   373 <countfp>

    if((child_initial_fp - child_modified_fp) == 1)
  40:	29 c3                	sub    %eax,%ebx
  42:	83 eb 01             	sub    $0x1,%ebx
  45:	74 1d                	je     64 <main+0x64>
      printf(1, "[Test 2] pass\n\n");
    else
      printf(1, "[Test 2] fail\n\n");
  47:	50                   	push   %eax
  48:	50                   	push   %eax
  49:	68 9e 07 00 00       	push   $0x79e
  4e:	6a 01                	push   $0x1
  50:	e8 fb 03 00 00       	call   450 <printf>
  55:	83 c4 10             	add    $0x10,%esp
  58:	eb 05                	jmp    5f <main+0x5f>
  }
  else{
    wait();
  5a:	e8 7c 02 00 00       	call   2db <wait>
  }
  ...
  64:	52                   	push   %edx
  65:	52                   	push   %edx
  66:	68 8e 07 00 00       	push   $0x78e
  6b:	6a 01                	push   $0x1
  6d:	e8 de 03 00 00       	call   450 <printf>
  72:	83 c4 10             	add    $0x10,%esp
  75:	eb e8                	jmp    5f <main+0x5f>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 10 08 00 00 	movzbl 0x810(%edx),%edx
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 b8 07 00 00 	jmp    *0x7b8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba ae 07 00 00       	mov    $0x7ae,%edx
        while(*s != 0){
 ...
 5f1:	a1 c0 0a 00 00       	mov    0xac0,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 c0 0a 00 00    	mov    %edx,0xac0
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 c0 0a 00 00    	mov    %edx,0xac0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d c0 0a 00 00    	mov    0xac0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d c0 0a 00 00    	mov    0xac0,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 c0 0a 00 00    	mov    0xac0,%edx
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 72f:	89 15 c0 0a 00 00    	mov    %edx,0xac0
}
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 c0 0a 00 00 c4 	movl   $0xac4,0xac0
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf c4 0a 00 00       	mov    $0xac4,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 c4 0a 00 00 c4 	movl   $0xac4,0xac4
 756:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 c8 0a 00 00 00 	movl   $0x0,0xac8
 762:	00 00 00 
    if(p->s.size >= nunits){
